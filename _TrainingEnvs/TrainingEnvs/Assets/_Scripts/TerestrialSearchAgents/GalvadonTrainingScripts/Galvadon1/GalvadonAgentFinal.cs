...
public class GalvadonAgentFinal : Agent
{
    ...
    [Header("Modelele folosite")]
   // [Tooltip("Model cautare hrana proprie")][SerializeField] private Barracuda.NNModel brain1_model = null;
    [Tooltip("Model care hraneste erbivorii")] [SerializeField] private Barracuda.NNModel brain2_model = null;
    ...
    private void OnCollisionEnter(Collision other)
    {
        if (other.gameObject.CompareTag("prey") && carryingFood == true)
        {
            AddReward(0.5f);
            canSwitch = 1;
            preyFood.gameObject.SetActive(false); // va fi in viitor destroy
    ...
    {
        GiveModel("GalvadonFeedLearning", brain2_model);
    }
}
