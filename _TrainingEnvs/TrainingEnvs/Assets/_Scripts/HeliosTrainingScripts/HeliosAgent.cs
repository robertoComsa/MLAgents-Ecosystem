...
public class HeliosAgent : Agent
{
    ...
    public override void CollectObservations()
    {
        ...
        // Total: 10 valori + Observatiile de tip raycast
    }
    ...
    private void FixedUpdate()
    {
        ...
        // 6 erbivori x 0.2 = 1.2 reward maxim (daca agentul nu ar apuca sa fie penalizat cu -0.02 pe step)
